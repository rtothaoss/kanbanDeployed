...
import academy.learnprogramming.kanban.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public Iterable<ProjectTask> getProjectByBacklog(@PathVariable String backlog_id, Principal principal) {
